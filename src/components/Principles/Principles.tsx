			...
			<div className='principles-middle'>
				<div className='principles-container'>
					...
					<div style={{ gridColumn: 2, gridRow: 2 }} className='principles-copy'>
						...
						diese können jedoch nur optimal behandelt werden, wenn die Therapie
						individuell auf den Patienten abgestimmt ist. Diese Idee bildet den
						Grundsatz bei logo albstadt. Dies bedeutet, dass wir vor
						Therapiebeginn einen umfänglichen und persönlichen Therapieplan
						erstellen und diesen kontinuierlich an den wirklichen
					...
					<div style={{ gridColumn: 2, gridRow: 2 }} className='principles-copy'>
						...
						individuelle Ziel eines jeden Patienten. Dieses besprechen wir stets
						zu Beginn einer Therapie und übersetzen es dann in konkrete
					...
					<div style={{ gridColumn: 2, gridRow: 2 }} className='principles-copy'>
						...
						besonders viel Zeit, um jeden Therapieschritt, jede Übung und jeden
						Fachbegriff verständlich zu erklären. Patienten können uns auch auf
						diese Weise besser Rückmeldung geben und so den Therapieerfolg
						verbessern.
					</div>
