			...
			<div className='actor-middle'>
				<div className='actor-container'>
					...
					<div className='actor-cv'>
						<ul>
							...
							<li>
								...
								Ausbildung zur Logopädin an der Bernd-Blindow-Schule in Leipzig
							</li>
						</ul>
					</div>
					<div className='actor-cert'>
						...
						<ul>
							<li>Diagnostik und Therapie von Schluckstörungen (Dysphagie)</li>
							<li>
						...
						<p>
							...
							besonders wichtig. Diesen und weitere Grundsätze bilden die Basis
